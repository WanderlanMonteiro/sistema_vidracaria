...
| Catálogo Super5 (ferragens para vidro temperado) | Extraído por completo (54 páginas) — **228 acessórios** com imagem de página vinculada, aplicação registrada em 100% dos itens (41 já ligados a uma tipologia existente — Correr/Basculante/Maxim-Ar/Pivotante/Giro; 187 aguardam vínculo individual às tipologias de vidro temperado já cadastradas — box, sacada, sanfonada, vitrine). Ver `docs/FONTES.md`. |
