...
| Planilha interna de cálculo de corte | Extraída — **77 fórmulas de corte reais** (996 componentes), a primeira fonte de fórmulas do projeto. Ver seção dedicada em `docs/FONTES.md` |
